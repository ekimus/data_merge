  ...
  describe "normalise_gdmqa/1" do
    ...
    test "returns normalised map" do
      expected = %{
        ...
        description: "This 5 star hotel is located on the coastline of Singapore.",
        amenities: [
          %{type: "general", amenity: "pool"},
          %{type: "general", amenity: "businesscenter"},
          %{type: "general", amenity: "wifi"},
          %{type: "general", amenity: "drycleaning"},
      ...
      actual = Client.normalise_gdmqa(@data)
    ...
    test "nil handling" do
      ...
      actual = Client.normalise_gdmqa(%{})
      assert actual == expected
    end
  end

  describe "normalise_1fva3m/1" do
    @data %{
      "hotel_id" => "iJhz",
      "destination_id" => 5432,
    ...
    test "returns normalised map" do
      ...
      actual = Client.normalise_1fva3m(@data)
      assert actual == expected
    end
    ...
    test "nil handling" do
      ...
      actual = Client.normalise_1fva3m(%{})
      assert actual == expected
    end
  end

  describe "normalise_j6kzm/1" do
    @data %{
      "id" => "iJhz",
      "destination" => 5432,
      "name" => "Beach Villas Singapore",
    ...
    test "returns normalised map" do
      ...
      actual = Client.normalise_j6kzm(@data)
      assert actual == expected
    end
